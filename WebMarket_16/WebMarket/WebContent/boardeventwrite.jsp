		...
		<form action="boardevent.jsp" method="post" name="member">
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						<td><a
							href="./boardeventshow.jsp?title=<%=board.getNumber()%>&page=<%=currentPage %>"><%=(currentPage - 1) * 10 + num%></a></td>
						<td><a
							href="./boardeventshow.jsp?title=<%=board.getNumber()%>&page=<%=currentPage %>"><%=board.getTitle()%></a></td>
