...
<script type="text/javascript">
	...
	function boardsearch() {
		var form = document.member;
		var url = 'boardinquiresearch_en.jsp?search='
...
<body>
	...
	<div class="container">
		...
		<h4 style="text-align: right;">
			<a href="boardinquirewrite.jsp">korea /</a>
			<a href="boardinquirewrite_en.jsp">english</a>
		</h4>
		<h2>inquire</h2>
		<%
		if (id == null) {
		...
		<form action="boardinquire_en.jsp" method="post" name="member">
			...
			<input type="button" value="search" onclick="boardsearch()" name="bt"
				...
				style="float: right;"> <input type="button" value="write"
